...
async function handleSubmit(data: z.infer<typeof formSchema>) {
  ...
  await changeOfficeDataById(formData)
}

export function OfficeTableActions({ data }: { data: Office }) {
